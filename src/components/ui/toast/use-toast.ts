...
type ToasterToast = ToastProps & { id: string; title?: string; description?: StringOrVNode; action?: Component };
...
function dispatch(action: Action) {
	switch (action.type) {
		...
		case actionTypes.DISMISS_TOAST: {
			...
			state.value.toasts = state.value.toasts.map((t) => (t.id === toastId || toastId === undefined ? { ...t, open: false } : t));
			break;
		}
